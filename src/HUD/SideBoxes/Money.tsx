        ...
        return (
            <div className={`moneybox ${this.props.side} ${this.props.team} ${this.props.show ? "show" : "hide"}`}>
                ...
                <div className="money_container">
                    ...
                    <div className="value">$ {this.props.loss.toLocaleString()}</div>
                </div>
                <div className="money_container">
                    <div className="title">Team Money</div>
                    <div className="value">$ {this.props.money.toLocaleString()}</div>
                </div>
                <div className="money_container">
                    <div className="title">Equipment Value</div>
                    <div className="value">$ {this.props.equipment.toLocaleString()}</div>
                </div>
            </div>
        );
    }
