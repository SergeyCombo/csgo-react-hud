...
function sum(grenades: WeaponRaw[], name: string) {
    return (
        grenades.filter(grenade => grenade.name === name).reduce((prev, next) => ({
            ...next,
    ...
    render() {
        return (
            <div className="grenade_container">
                ...
                <div className="grenade_amount">
                    <span className="grenade_amount--divider">x</span>
                    {this.props.amount}
                </div>
            </div>
        );
        ...
        return (
            <div className={`utilitybox ${this.props.side || ''} ${this.props.show ? "show" : "hide"}`}>
                ...
                <div className="grenades_container">
                    ...
                    <GrenadeContainer grenade={this.props.side === 'CT' ? 'incgrenade' : 'molotov'}
                                      amount={grenades.inc}/>
