            ...
            <div
                ...
                <div className="player_data">
                    ...
                    <div className={`avatar`}>
                        <img src={demoAva} height={57} width={57} alt={'Avatar'}/>
                    </div>
                    ...
                    <div className="player_stats">
                        <div className="row">
                            ...
                            <div className="username">
                                <div>{isLeft ? <span>{player.observer_slot}</span> : null} {player.name} {!isLeft ?
                                    <span>{player.observer_slot}</span> : null}</div>

                                {primary || secondary ?
                                    <Weapon weapon={primary ? primary.name : secondary.name} active={true}/> : ""
                                }
                                {player.state.round_kills ?
                                    <div className="roundkills-container">{player.state.round_kills}</div> : null
                                }
                            </div>
                        </div>
                        <div className="row">
